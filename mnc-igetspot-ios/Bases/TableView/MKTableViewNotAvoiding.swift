...
@objc protocol MKTableViewNotAvoidingDelegate {
    func createRows()
    func createSections()
    func registerNibs()
...
class MKTableViewNotAvoiding: UIView {
    ...
    var delegate: MKTableViewNotAvoidingDelegate?
    ...
    func registerDelegate(delegate: MKTableViewNotAvoidingDelegate) {
    ...
    func reloadSection(section: MKTableViewSection) {
        ...
        if sectionPosition > -1 {
            ...
            tableView.reloadSections(NSIndexSet(index: sectionPosition) as IndexSet, with: .none)
...
extension MKTableViewNotAvoiding:  UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        if let view = sections[section].getHeader() {
            return view
        }
        return nil
    }

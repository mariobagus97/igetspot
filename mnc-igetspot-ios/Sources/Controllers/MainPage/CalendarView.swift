...
class CalendarView: UIView, FSCalendarDataSource {
    ...
    func igsColor(){
        ...
        self.calendar.appearance.todayColor = Colors.blueTwo
        self.calendar.appearance.selectionColor = Colors.gradientThemeOne
        self.calendar.appearance.subtitleWeekendColor = Colors.brownishGrey
        self.calendar.appearance.titleWeekendColor = Colors.brownishGrey
        self.calendar.appearance.weekdayTextColor = UIColor.black
        self.calendar.appearance.weekdayFont = R.font.barlowBold(size: 12)
        self.calendar.appearance.headerTitleColor = Colors.blueTwo
        self.calendar.appearance.headerTitleFont = R.font.barlowMedium(size: 16)
        self.calendar.appearance.titleFont = R.font.barlowMedium(size: 14)
    }
